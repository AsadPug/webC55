    ...
    <body>
        <div>
            <main>
                <div id="house">
                    <?php
                        foreach ($data["lights_status"] as $light_status){
                            if($light_status["status"] == true){
                                ?>
                                <img src="img/light-on.png" alt=<?=$light_status["name"]?> id=<?= $light_status["name"]?>>
                                <?php
                            }
                            else {
                                ?>
                                <img src="img/light-off.png" alt=<?=$light_status["name"]?> id=<?= $light_status["name"]?>>
                                <?php
                            }
                        }
                    ?>
            ...
            <footer>
                <div>
                    ...
                    <div>
                        <div>
                            <a href=""><img src="img/btn-refresh.png" alt="refresh" class="btn-refresh"></a>
                        </div>
